"""
collect/eks 的来源已经在 dy-ele.js 里确认（见 请求链路.md）：
...
if __name__ == "__main__":
    src = Path(__file__).parent.joinpath("tdc.js").read_text(encoding="utf-8")
    result = get_collect_and_eks(src)
    print("collect (前100字符):", result["collect"][:100])
    print("eks (前100字符):", result["eks"][:100])
    print("tokenid:", result["tokenid"])
